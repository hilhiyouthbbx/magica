...
const DEFAULT: DayData[] = [
  ...
  },
  {
    ...
    rows: [
      ...
      { id:"4-8",  time:"11:45 AM", activity:"LAYUP CONTEST (Team Event)",            note:"Right 1 min + Left 1 min | Team total wins",    type:"game"      },
      { id:"4-9",  time:"12:00 PM", activity:"Lunch / Bracket Reveal",                note:"45 min",                                        type:"break"     },
      { id:"4-10", time:"12:45 PM", activity:"SEMIFINAL GAMES — NBA & College",       note:"Both courts simultaneously | 2x12-min clock",   type:"game"      },
      { id:"4-11", time:"1:25 PM",  activity:"CHAMPIONSHIP GAMES — NBA & College",    note:"Both courts simultaneously | 2x20-min clock",   type:"highlight" },
